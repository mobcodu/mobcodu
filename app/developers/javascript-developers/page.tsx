...
export default function JavaScriptDevelopersPage() {
  const services = [
      ...
      <section className="py-32">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 mt-6 max-w-3xl mx-auto text-lg">
            Build fast, interactive and scalable web applications
            with our experienced JavaScript developers using
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-gray-400 text-lg leading-relaxed">
            JavaScript powers modern web applications. Our JavaScript
            developers create high-performance websites, web apps,
            APIs and enterprise solutions using the latest JavaScript
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10 text-center">
              ...
              <p className="text-gray-400">
                Architecture built for business growth.
              </p>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-400 mt-2">
                ...
                for building interactive and scalable web applications.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-400 mt-2">
                Yes, we specialize in React, Next.js, Node.js,
                Express.js and the complete JavaScript ecosystem.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-400 mt-2">
                Yes, we provide maintenance, upgrades,
