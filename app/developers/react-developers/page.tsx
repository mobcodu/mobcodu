      ...
      <section className="py-32">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 mt-6 max-w-3xl mx-auto text-lg">
            Build fast, scalable and modern web applications with our
            experienced React developers using the latest frontend technologies.
          </p>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-gray-400 text-lg leading-relaxed">
            Our React developers create dynamic, high-performance and
            user-friendly web applications. We build responsive interfaces,
            scalable frontend architectures and seamless user experiences
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10 text-center">
              ...
              <p className="text-gray-400">
                Latest React ecosystem and frontend technologies.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10 text-center">
              ...
              <p className="text-gray-400">
                Optimized web applications with superior performance.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10 text-center">
              ...
              <p className="text-gray-400">
                Frontend architecture built for long-term growth.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="mt-4">UI & Architecture Planning</p>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-400 mt-2">
                React enables fast, scalable and interactive web applications
                with reusable components and excellent performance.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-400 mt-2">
                Yes, we specialize in both React and Next.js development
                for SEO-friendly and high-performance web applications.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-400 mt-2">
                ...
                long-term support for React applications.
              </p>
            </div>
